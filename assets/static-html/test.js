...
(function($PS) {
  ...
  var render = function (state) {
      ...
      }) ])([ Halogen_HTML_Core.text("-") ]), Halogen_HTML_Core.text(Data_Show.show(Data_Show.showRecord()(Data_Show.showRecordFieldsCons({
      ...
      })(Data_Show.showRecordFieldsNil)(Data_Show.showString))(Data_Show.showInt)))(state)), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
          return Increment.value;
      }) ])([ Halogen_HTML_Core.text("+") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Events.onValueInput(Input.create) ]) ]);
  };
  ...
  var handleAction = function (v) {
      ...
      throw new Error("Failed pattern match at Main (line 55, column 16 - line 63, column 47): " + [ v.constructor.name ]);
  };
