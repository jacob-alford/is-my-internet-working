      ...
      append: function (v) {
          return function (v1) {
              ...
              if (v instanceof Plain && v1 instanceof Prefixed) {
                  return new Prefixed(Data_Functor.map(Data_Functor.functorArray)(Data_Profunctor_Strong.second(Data_Profunctor_Strong.strongFn)(function (v2) {
                      return v.value0 + v2;
                  }))(v1.value0));
              };
              ...
              if (v instanceof Prefixed && v1 instanceof Prefixed) {
                  return new Prefixed(Data_Semigroup.append(Data_Semigroup.semigroupArray)(v.value0)(v1.value0));
              };
...
(function($PS) {
  ...
  var render = function (state) {
      ...
      return Halogen_HTML_Elements.div([ renderStyles ])([ Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
          return Decrement.value;
      }) ])([ Halogen_HTML_Core.text("-") ]) ]), Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showRecord()(Data_Show.showRecordFieldsCons({
      ...
      })(Data_Show.showRecordFieldsNil)(Data_Show.showString))(Data_Show.showInt)))(state)) ]), Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
          return Increment.value;
      }) ])([ Halogen_HTML_Core.text("+") ]) ]), Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.input([ Halogen_HTML_Events.onValueInput(Input.create) ]) ]) ]);
  };
  ...
  var handleAction = function (v) {
      ...
      throw new Error("Failed pattern match at Main (line 70, column 16 - line 78, column 47): " + [ v.constructor.name ]);
  };
