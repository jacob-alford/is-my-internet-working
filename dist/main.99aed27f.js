...
(function($PS) {
    ...
    var semigroupPrefixed = {
        append: function(v) {
            return function(v1) {
                if (v instanceof Plain1 && v1 instanceof Plain1) return new Plain1(v.value0 + v1.value0);
                if (v instanceof Plain1 && v1 instanceof Prefixed1) return new Prefixed1(Data_Functor.map(Data_Functor.functorArray)(Data_Profunctor_Strong.second(Data_Profunctor_Strong.strongFn)(function(v2) {
                    return v.value0 + v2;
                }))(v1.value0));
                if (v instanceof Prefixed1 && v1 instanceof Plain1) return new Prefixed1(Data_Functor.map(Data_Functor.functorArray)(Data_Profunctor_Strong.second(Data_Profunctor_Strong.strongFn)(function(v2) {
                    return v1.value0 + v2;
                }))(v.value0));
                if (v instanceof Prefixed1 && v1 instanceof Prefixed1) return new Prefixed1(Data_Semigroup.append(Data_Semigroup.semigroupArray)(v.value0)(v1.value0));
                throw new Error("Failed pattern match at CSS.Property (line 23, column 1 - line 27, column 59): " + [
                    v.constructor.name,
                    v1.constructor.name
                ]);
            };
    ...
    var semigroupValue = {
        append: function(v) {
            return function(v1) {
                return Data_Semigroup.append(semigroupPrefixed)(v)(v1);
            };
        }
    };
    var isStringPrefixed = {
        fromString: Plain1.create
    };
    var isStringValue = {
        fromString: function() {
    ...
    exports["value"] = value;
    exports["Prefixed"] = Prefixed1;
    exports["Plain"] = Plain1;
    exports["cast"] = cast;
        ...
        return function(dictEq) {
            return function(a) {
                ...
                var $324 = foldMap(dictFoldable)(Data_Maybe_First.monoidFirst)(function(v) {
                    ...
                    if ($305) return new Data_Maybe.Just(v.value1);
...
(function($PS) {
    ...
    var key = function(dictVal) {
        return function(k) {
            return function(v) {
                return rule(new Property1(CSS_Property.cast(k), CSS_Property.value(dictVal)(v)));
            };
        };
    };
    var functorStyleM = {
    ...
    var bindStyleM = {
        bind: function(v) {
            return function(f) {
                return Control_Bind.bind(Control_Monad_Writer_Trans.bindWriterT(Data_Semigroup.semigroupArray)(Data_Identity.bindIdentity))(v)(function($295) {
                    return function(v1) {
                        return v1;
                    }(f($295));
                });
...
(function($PS) {
    ...
    var flex = CSS_String.fromString(CSS_Property.isStringValue)("flex");
...
(function($PS) {
    ...
    var CSS_Stylesheet = $PS["CSS.Stylesheet"];
    var Data_Tuple = $PS["Data.Tuple"];
    var wrap = CSS_String.fromString(CSS_Property.isStringValue)("wrap");
    ...
    var column = CSS_String.fromString(CSS_Property.isStringValue)("column");
...
(function($PS) {
    ...
    var collect$prime = function(v) {
        return function(v1) {
            if (v instanceof CSS_Property.Plain && v1 instanceof CSS_Property.Plain) return [
                new Data_Either.Right(new Data_Tuple.Tuple(v.value0, v1.value0))
            ];
            if (v instanceof CSS_Property.Prefixed && v1 instanceof CSS_Property.Plain) return Data_Functor.map(Data_Functor.functorArray)(function(v3) {
                return new Data_Either.Right(new Data_Tuple.Tuple(v3.value0 + v3.value1, v1.value0));
            })(v.value0);
            if (v instanceof CSS_Property.Plain && v1 instanceof CSS_Property.Prefixed) return Data_Functor.map(Data_Functor.functorArray)(function(v2) {
                return new Data_Either.Right(new Data_Tuple.Tuple(v.value0, v2.value0 + v2.value1));
            })(v1.value0);
            if (v instanceof CSS_Property.Prefixed && v1 instanceof CSS_Property.Prefixed) return Data_Functor.map(Data_Functor.functorArray)(function(v2) {
            ...
            throw new Error("Failed pattern match at CSS.Render (line 156, column 1 - line 156, column 80): " + [
                v.constructor.name,
                v1.constructor.name
            ]);
        };
...
(function($PS) {
    ...
    var coyoneda = function(k) {
        return function(fi) {
            return Data_Exists.mkExists(new CoyonedaF1(k, fi));
        };
    };
    var functorCoyoneda = {
        map: function(f) {
        ...
        return function(f) {
            return function(mz) {
                return function(m) {
                    ...
                    for(var k2 in m)if (hasOwnProperty.call(m, k2)) acc = bind(acc)(g(k2));
                    return acc;
                };
            };
        };
...
(function($PS) {
    ...
    var monadStateHalogenM = {
        state: function($134) {
            return HalogenM(Control_Monad_Free.liftF(State1.create($134)));
        },
        Monad0: function() {
...
(function($PS) {
    ...
    var propToStrKey = function(v) {
        ...
        if (v instanceof Property2) return "prop/" + v.value0;
        ...
        return function(el) {
            var removeProp = function(prevEvents) {
                return function(v, v1) {
                    ...
                    if (v1 instanceof Property2) return removeProperty(v1.value0, el);
...
(function($PS) {
    ...
    var style = function() {
        ...
        var property = function(v) {
            if (v instanceof CSS_Stylesheet.Property) return new Data_Maybe.Just(new Data_Tuple.Tuple(v.value0, v.value1));
            return Data_Maybe.Nothing.value;
        };
...
(function($PS) {
    ...
    var render = function(state) {
        var renderStyles = Halogen_HTML_CSS.style(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.flex))(function() {
            return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Flexbox.flexFlow(CSS_Flexbox.column)(CSS_Flexbox.wrap))(function() {
                return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Flexbox.alignItems(new CSS_Property.Plain("center")))(function() {
                    return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Flexbox.justifyContent(new CSS_Property.Plain("center")))(function() {
                        return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.width(new CSS_Property.Plain("100%")))(function() {
                            return CSS_Geometry.height(new CSS_Property.Plain("100vh"));
                        });
                    });
                });
            });
        ...
        return Halogen_HTML_Elements.div([
            ...
            Halogen_HTML_Elements.div_([
                Halogen_HTML_Core.text(Data_Show.show(Data_Show.showRecord()(Data_Show.showRecordFieldsCons({
                ...
                })(Data_Show.showRecordFieldsNil)(Data_Show.showString))(Data_Show.showInt)))(state))
            ]),
            Halogen_HTML_Elements.div_([
                Halogen_HTML_Elements.button([
                    Halogen_HTML_Events.onClick(function(v) {
            ...
            Halogen_HTML_Elements.div_([
                Halogen_HTML_Elements.input([
                    Halogen_HTML_Events.onValueInput(Input1.create)
                ])
            ])
        ]);
    };
    var initialState = function(v) {
        return {
            counter: 0,
            inputBox: Data_Monoid.mempty(Data_Monoid.monoidString)
        };
    };
    var handleAction = function(v) {
        if (v instanceof Decrement1) return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function(state) {
            var $9 = {};
            for(var $10 in state)if (({}).hasOwnProperty.call(state, $10)) $9[$10] = state[$10];
            $9.counter = state.counter - 1 | 0;
            return $9;
        });
        if (v instanceof Increment1) return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function(state) {
            var $12 = {};
            for(var $13 in state)if (({}).hasOwnProperty.call(state, $13)) $12[$13] = state[$13];
            $12.counter = state.counter + 1 | 0;
            return $12;
        });
        if (v instanceof Input1) return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function(state) {
            var $15 = {};
            for(var $16 in state)if (({}).hasOwnProperty.call(state, $16)) $15[$16] = state[$16];
            $15.inputBox = v.value0;
            return $15;
        });
        throw new Error("Failed pattern match at Main (line 70, column 16 - line 78, column 47): " + [
            v.constructor.name
        ]);
    };
    ...
    exports["Increment"] = Increment1;
    exports["Decrement"] = Decrement1;
...
//# sourceMappingURL=main.99aed27f.js.map
